drop view if exists city_view_2020;

create view city_view_2020
as
SELECT
  c.state_name,
  c.city_name,
  ...
  (
    ...
    FROM
      ...
      WITH
        ...
        (
          ...
          FROM
            city_master
          WHERE
            city_master.publication_year = 2020::NUMERIC
        )
        ,
        pop_10 AS
        (
          ...
          FROM
            city_master
          WHERE
            city_master.publication_year   = 2010::NUMERIC
      ...
      SELECT
        ...
        (pop_20.population_2020 - pop_10.population_2010) /
        pop_10.population_2010 AS pop_growth
      FROM
        pop_20
      JOIN pop_10
      ON
        pop_20.geo_id::text = pop_10.geo_id::text
      )
      pop_growth
  )
  pg
...
WHERE
  c.publication_year = 2020::NUMERIC
AND
  (
